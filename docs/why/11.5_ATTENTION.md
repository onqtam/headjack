...
> "We characterize consciousness as a specific pattern of information processing involving coherence maximization, second-order perception, and self-organizing developmental dynamics." - [The California Institute for Machine Consciousness Research Program](https://drive.google.com/file/d/1IztggGcF19hYvGKCHLenIcPyfX2Nszyr/view)
...
even if it turns out that its impossible that we can create it artificially out of silicon - it might turn out that if we acted as the cells/neurons that it is possible
...
Consciousness is a function that transforms representational patterns into others

## The Machine Consciousness Hypothesis

Some excerpts from the full paper:

<details><summary>Minds as computer programs</summary><p>
...
<details><summary>Mind, Self and Consciousness</summary><p>
