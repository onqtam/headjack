...
> "But, what can go meta…on the meta? Recently, the nascent field of archdisciplinarity has emerged as a domain of inquiry dedicated to unifying and integrating metatheories by trying to identify so-called “arches” that obtain across numerous big picture perspectives. As I will argue in the following pages, there is a recursive process at work in cultural logics, meaning there is always a higher vantage that might render the current limits of a discourse (even seemingly irreconcilable ones) relatable to one another within a broader context. It just takes identifying the larger classificatory set that contains the discourses as a subset. Thus, if there are different metamodern metatheories, an archtheoretical account would attempt to see what they all share in common, and thereby overcome their seeming contradictions by abstracting the deeper patterns that unite them." - [Metamodernism, Or, The Cultural Logic of Cultural Logics, by Brendan Graham Dempsey](https://www.goodreads.com/book/show/199434578-metamodernism)
...
> "" - [Metamodernism, Or, The Cultural Logic of Cultural Logics, by Brendan Graham Dempsey](https://www.goodreads.com/book/show/199434578-metamodernism)
