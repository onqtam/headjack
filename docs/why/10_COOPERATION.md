...
collective action problems = free rider problem (prisoners' dilemma) + coordination problems
...
common knowledge example with cc vs bcc in email, also for someone coming out as gay in 1 on 1 convos with everyone before making it public
