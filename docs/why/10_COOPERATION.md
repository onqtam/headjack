...
> "An account of modeling in general as normative, foundational to life, and arising from computation in living systems troubles some still-influential ideas in Western philosophy. One is David Hume’s “is/ought” distinction, which seeks to distinguish descriptive from normative statements. Hume privileged description, which was a progressive idea at the time. He held that descriptive statements ought to take precedence over normative judgments—and precede them, or we wouldn’t find it so irritating when people express opinions about topics they don’t understand. For Hume, facts (“is” statements) are universal, while opinions (“ought” statements) are merely personal.
>
> While intuitive, the is/ought dichotomy falls apart when we realize that models are not just inert matrices of numbers or Platonic ideas floating around in a sterile universe. Models are functions computed by living beings; they arguably define living beings. As such, they are always purposive, inherent to an active observer. Observers are not disinterested parties. Every “is” has an ineradicable “oughtness” about it. Our umwelten are what they are for good reasons—the wavelengths we see or don’t, the categories we distinguish or don’t, the variables we deem salient or not." - [What Is Intelligence? Lessons from AI About Evolution, Computing, and Minds, by Blaise Agüera y Arcas](https://whatisintelligence.antikythera.org/)

> "So right now we have this massive lever on our choice from technology, but without a commensurate quality of guiding choice. That's an extinction equation. When I talk about generator functions of X-risk - that's the heart of it. So we need a theory of ought that is as robust and fully commensurable as our theory of is. Which means we need a kind of reified ethics that is commensurable with the philosophhy of science and can actually be a basis of what we should develop technology and service to. That's why I got into - I mean there are many people who have worked on this, obviously, right? And there are good steps - like - you know - there are good things in what Rawls did, there are good things in what many kinds of ethical theorists did, I actually found the most robust tretus on the underlying philosophy in the Immanent Metaphysics in Forrest Landry's work, which is why he became a good friend and mentor and that. So I think it's fair to say - which is very different than how I would talk to anyone actually, right, there is an enactment problem here - but I think it's fair to say that if we can make choices that have effects that we don't even realize and we can't contemplate, but we're making them - the chance that things continue to go well is small. And if we are trying to do things that we think are good that cause inexorable conflict with increasing capacity for larger conflict - the chance things continue to be stable is small. So figuring out how to find what in everyone's values - what is the essence in the values that maybe with a different strategy can be not mutually exclusive or somehow intercommensurable with all the other values, so that's an evolution of a more inclusive ethical framework and then a more complex epistemic framework that can actually calculate the cause and effect - the information theory - enough to say: what is an appropriate technology or injunction or whatever. Those 2 things are necessary for humanity to continue to do well." - [Daniel Schmachtenberger](https://youtu.be/Pyy3veuvXVE?t=3648)

^^ from 1:00:48 till 1:03:04
^^ this is related to causality and understanding of the interlinking of everything
...
<details><summary>The Is-Ought Connection - excerpt from "Metamodernism, Or, The Cultural Logic of Cultural Logics" by Brendan Graham Dempsey</summary><p>

> "To the issue of value Storm devotes an entire chapter, in which he unmasks postmodernism’s supposed “ethical nihilism” for what it really is: a moralist program presented in negative terms. By negating that negation, he says, we can stop hiding behind critique to express our values and instead simply name them in positive, affirmational terms. This invitation, though, is part of a broader philosophical move to reconnect ontology and normativity, being and value, “is” and “ought.” Indeed, many pathologies of the postmodern academic paradigm emerged out of the supposed imperative that these be kept apart, forcing values “underground” and into the language of critique.
>
> Storm cites numerous ways the supposedly iron-clad is/ought distinction breaks down, but I will note just one important example since it seems a logical extension from the arguments noted above linking interpretation to reality. That is, if organisms (like humans) are indeed navigating some kind of world to eat, reproduce, etc., then one’s hermeneutics will be tied to some basic goal states. But goal states entail normativity. Interpreting entities will value what keeps them in the world (indeed, that would seem to be the meaning of meaning itself!). Storm expresses this idea as follows:
>
> *"In most cases, it would seem that we ought to have accurate beliefs about the world. For instance, the statement “this glass contains arsenic” is the epitome of a non-normative descriptive statement of fact. But if “this glass contains arsenic,” then it would also seem that I ought to believe “this glass contains arsenic,” especially if I am feeling thirsty. This could be extended to most correct statements about the world. If “it is snowing,” then I ought to believe it is snowing (especially when picking a jacket); if “smoking causes cancer,” then I ought to believe that smoking causes cancer, and so on. These examples pose problems for the conventional account of the relationship between fact and value because they all represent a direct movement from a description (fact or “is”) to an ought. Restated, they all provide clear evidence that non-normative descriptions can reasonably lead to normative conclusions. Indeed, all this suggests that correct belief itself is a value-laden or normative concept, that we should have accurate beliefs about facts or non-normative aspects of the world, and for very functional purposes."*
>
> Given the many ways that values emerge necessarily from meaning-making entities, we are kidding ourselves if we keep with the postmodern paradigm—one that engages in its own performative contradiction by declaring values fictive while directing its deconstructive scholarship to progressive social causes like feminism, anti-racism, etc. The unfortunate irony is that the postmodern paradigm has tied its own hands behind its back to actually affect real, positive, progressive change in the world—for what is “real”? and what is “positive”? and don’t we know that “progress” and “the world” are myths? Only by shifting the paradigm out of antithesis and the negative can we hope to achieve positive goals. Storm writes: *“We will never solve anthropogenic climate change, structural racism, or patriarchal hegemony if we are incapable of thinking in terms of totalities.”* Metamodernism invites us to put our values on the table instead of pretending they don’t exist.
>
> Again, the connections to metamodern aesthetics are pertinent. The sincerity and earnestness one sees in metamodern art often strike us precisely because they represent affirmations of value as opposed to normative presumptions framed as critical judgments. Applying Storm’s insight to postmodern art, one can indeed see the positive values that underly even its dark shades of cynicism. The mocking of blind conformity and consumerism that one finds, for instance, in the music of The Talking Heads, Nirvana, or Radiohead, as well as in the films of Terry Gilliam, Oliver Stone, and David Fincher, presumes a positive commitment to authentic free-thinking, humanitarian values, and a sincere investment and regard for things not simply based on their superficial, materialistic worth in order for their critiques to land. The dystopian concerns of Blade Runner (1982) or American Psycho (2000) are predicated on underlying aspirations for real human depth and flourishing which feel threatened. Critique frames in negative terms a set of values by attacking instances where those values are absent. We have become so used to the register of normative pleas in the negative that it comes as a shock to hear them expressed in positive ones. Waymond’s appeal in Everything Everywhere All at Once – “Please, be kind” – is not the declarative, let alone imperative, language we are accustomed to when it comes to normative stances, which have for so long come through ironic derision. With the metamodern turn, though, the negative is inverted, revealing the (often rather simple) values that cynicism had obscured. The metamodernist simply owns the types of values the postmodernist held covertly, risking reflective critique in the process." - [Metamodernism, Or, The Cultural Logic of Cultural Logics, by Brendan Graham Dempsey](https://www.goodreads.com/book/show/199434578-metamodernism)
...
> "This is Moloch in perfect form. A textbook multipolar trap... Here is the structure. Every participant is making the locally correct move. A player who dislikes the norm-violation but refuses to match it gets strictly worse outcomes than a player who matches the norm making move. Unilateral restraint in a defection game does not produce a better world; it produces the same defected world with one fewer voice at the table. The prisoner who refuses to defect after the other prisoner already has is not nobler, just convicted... It is also how the worst equilibrium arrives... This is the ratchet property of multipolar traps: each round resets the baseline, the baseline only moves in one direction, and the moves get bigger as participants learn what the game now permits.
>
...
>
> ... The trap will... continue, and the equilibrium will worsen, until the cost of the game exceeds the cost of coordinating... That is the power of a multipolar trap: game theory forces us to do the wrong thing. Outlawing the move is the only way to release all of us from the trap." - [Jim Rutt](https://jimrutt.substack.com/p/moloch-comes-to-virginia)
